...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تجريبي</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    تعديل منتج</span>
            </div>
        </div>
    </div>
                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Product_name_ar" name="name[ar]"
                                       value="{{ old('name.ar', $product->getTranslation('name', 'ar')) }}" required>
                            </div>
                            <div class="col">
                                <label for="Product_name_en">اسم المنتج (en)</label>
                                <input type="text" class="form-control" id="Product_name_en" name="name[en]"
